...
bool pp2_setup_joynet(void)
{
	...
	joynet_add_game_option(pp2_client_game, (int *)(&pp2_seed));
	joynet_add_game_option(pp2_client_game, &pp2_end_game_option);
	joynet_add_game_option(pp2_client_game, &pp2_option[PP2_OPTION_GAME_MODE]);
	joynet_add_game_option(pp2_client_game, &pp2_option[PP2_OPTION_ELIMINATION_HITS]);
	joynet_add_game_option(pp2_client_game, &pp2_option[PP2_OPTION_CTF_FLAGS]);
	joynet_add_game_option(pp2_client_game, &pp2_option[PP2_OPTION_TIME_LIMIT]);
	joynet_add_game_option(pp2_client_game, &pp2_option[PP2_OPTION_ENABLE_AMMO_NORMAL]);
	joynet_add_game_option(pp2_client_game, &pp2_option[PP2_OPTION_ENABLE_AMMO_X]);
	joynet_add_game_option(pp2_client_game, &pp2_option[PP2_OPTION_ENABLE_AMMO_MINE]);
	joynet_add_game_option(pp2_client_game, &pp2_option[PP2_OPTION_ENABLE_AMMO_BOUNCE]);
	joynet_add_game_option(pp2_client_game, &pp2_option[PP2_OPTION_ENABLE_AMMO_SEEK]);
	joynet_add_game_option(pp2_client_game, &pp2_option[PP2_OPTION_ENABLE_AMMO_REFLECTOR]);
	joynet_add_game_option(pp2_client_game, &pp2_option[PP2_OPTION_ENABLE_AMMO_PMINE]);
	joynet_add_game_option(pp2_client_game, &pp2_option[PP2_OPTION_ENABLE_AMMO_GHOST]);
	joynet_add_game_option(pp2_client_game, &pp2_option[PP2_OPTION_ENABLE_POWERUP_CLOAK]);
	joynet_add_game_option(pp2_client_game, &pp2_option[PP2_OPTION_ENABLE_POWERUP_JUMP]);
	joynet_add_game_option(pp2_client_game, &pp2_option[PP2_OPTION_ENABLE_POWERUP_RUN]);
	joynet_add_game_option(pp2_client_game, &pp2_option[PP2_OPTION_ENABLE_POWERUP_DEFLECT]);
	joynet_add_game_option(pp2_client_game, &pp2_option[PP2_OPTION_ENABLE_POWERUP_FLY]);
	joynet_add_game_option(pp2_client_game, &pp2_option[PP2_OPTION_ENABLE_POWERUP_TURBO]);
	joynet_add_game_option(pp2_client_game, &pp2_option[PP2_OPTION_START_AMMO_NORMAL]);
	joynet_add_game_option(pp2_client_game, &pp2_option[PP2_OPTION_START_AMMO_X]);
	joynet_add_game_option(pp2_client_game, &pp2_option[PP2_OPTION_START_AMMO_MINE]);
	joynet_add_game_option(pp2_client_game, &pp2_option[PP2_OPTION_START_AMMO_BOUNCE]);
	joynet_add_game_option(pp2_client_game, &pp2_option[PP2_OPTION_START_AMMO_SEEK]);
	joynet_add_game_option(pp2_client_game, &pp2_option[PP2_OPTION_START_AMMO_REFLECTOR]);
	joynet_add_game_option(pp2_client_game, &pp2_option[PP2_OPTION_START_AMMO_PMINE]);
	joynet_add_game_option(pp2_client_game, &pp2_option[PP2_OPTION_START_AMMO_GHOST]);
	joynet_add_game_option(pp2_client_game, &pp2_option[PP2_OPTION_DEATH_MATCH_FRAGS]);
	joynet_add_game_option(pp2_client_game, &pp2_option[PP2_OPTION_LIFE]);
	joynet_add_game_option(pp2_client_game, &pp2_option[PP2_OPTION_RANDOMIZE_ITEMS]);
	joynet_add_game_option(pp2_client_game, &pp2_option[PP2_OPTION_STOMP_HITS]);
	joynet_add_game_option(pp2_client_game, &pp2_option[PP2_OPTION_AMMO_WORTH]);
