...
#define PP2_CONTROLLER_RIGHT     T3F_GAMEPAD_DPAD_RIGHT
#define PP2_CONTROLLER_JUMP      T3F_GAMEPAD_A
#define PP2_CONTROLLER_FIRE      T3F_GAMEPAD_X
...
#define PP2_BITMAP_HUD_SCORE     21
#define PP2_BITMAP_HUD_LIVES     22
#define PP2_BITMAP_HUD_TIMER     23
#define PP2_BITMAP_HUD_AMMO      24
