...
void t3f_reset_input_handler_state(T3F_INPUT_HANDLER * input_handler)
{
  ...
  for(i = 0; i < input_handler->elements; i++)
  {
    input_handler->element[i].on = false;
...
static void _read_input_handler_element_device_keyboard(T3F_INPUT_HANDLER_ELEMENT * element)
{
...
static void _read_input_handler_element_device_mouse(T3F_INPUT_HANDLER_ELEMENT * element)
{
  int button;
...
static void _read_input_handler_element_device_touch(T3F_INPUT_HANDLER_ELEMENT * element)
{
}

static void _update_input_handler_element_joystick_cache(T3F_INPUT_HANDLER_ELEMENT * element)
{
  int i, j;
...
static void _read_input_handler_element_device_joystick(T3F_INPUT_HANDLER_ELEMENT * element)
{
  float tval;
  float val;

  _update_input_handler_element_joystick_cache(element);
...
/* read physical devices mapped to input_handler */
void t3f_read_input_handler_devices(T3F_INPUT_HANDLER * input_handler)
{
  ...
  for(i = 0; i < input_handler->elements; i++)
  {
    switch(input_handler->element[i].device_type)
    {
      case T3F_INPUT_HANDLER_DEVICE_TYPE_KEYBOARD:
      {
        _read_input_handler_element_device_keyboard(&input_handler->element[i]);
        break;
      }
      case T3F_INPUT_HANDLER_DEVICE_TYPE_MOUSE:
      {
        _read_input_handler_element_device_mouse(&input_handler->element[i]);
        break;
      }
      case T3F_INPUT_HANDLER_DEVICE_TYPE_TOUCH:
      {
        _read_input_handler_element_device_touch(&input_handler->element[i]);
        break;
      }
      case T3F_INPUT_HANDLER_DEVICE_TYPE_JOYSTICK:
      {
        _read_input_handler_element_device_joystick(&input_handler->element[i]);
        break;
      }
    }
  }
...
static void _inject_input_handler_element_state(T3F_INPUT_HANDLER_ELEMENT * element, bool held, float val)
{
  element->on = held;
  element->val = val;
}
...
{
  _inject_input_handler_element_state(&input_handler->element[element], held, val);
}
