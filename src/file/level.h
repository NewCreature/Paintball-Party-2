...
#define PP2_LEVEL_COLLISION_FLAG_ICE      (T3F_COLLISION_FLAG_USER)
#define PP2_LEVEL_COLLISION_FLAG_CONVEYOR (T3F_COLLISION_FLAG_USER << 1)
#define PP2_LEVEL_COLLISION_FLAG_SECRET   (T3F_COLLISION_FLAG_USER << 2)
